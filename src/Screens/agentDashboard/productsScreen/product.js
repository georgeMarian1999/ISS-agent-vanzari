...
const Product = (props) =>{
    ...
    const handleBuy = () =>{
        setLoading(true);
        props.comanda(props.product.produsID,cantitate);
    ...
    return(
        <div>
            ...
            <div>
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">{"Confirma plasare comanda"}</DialogTitle>
                    <DialogContent className="dialogcontent">
                        <DialogContentText>{props.product.numeProdus}</DialogContentText>
                        <DialogContentText>Cantitate</DialogContentText>
                        <DialogContentText>Pret total {total} lei</DialogContentText>
